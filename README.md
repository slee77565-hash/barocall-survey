...
다만 이 규모는 파일럿 또는 1차 수집 기준으로 보는 것이 안전합니다. 본 연구의 핵심은 주효과가 아니라
2×2 상호작용과 조절된 매개효과인데, 참고한 선행연구의 상호작용 효과크기가 편에타제곱 0.02~0.03 수준으로
작습니다. 총 160명으로는 이 정도 크기의 상호작용을 안정적으로 검출하기 어렵고, 조절된 매개는 더 큰
표본을 요구합니다.
참고로 유의수준 .05, 검정력 .80 기준으로 1자유도 상호작용을 검출하려면 편에타제곱 .03에서 약 250명,
.02에서 약 390명이 필요합니다. 조절된 매개까지 확증적으로 보려면 더 보수적으로 잡아야 하므로,
본조사는 총 350~450명 수준을 먼저 검토하는 편이 안전합니다.
주의할 점이 하나 있습니다. "1차 결과를 보고 효과크기를 확인한 뒤 표본을 추가한다"는 방식은
중간 결과를 보고 수집을 멈추거나 늘리는 것이 되어 1종 오류가 부풀려집니다. 이를 피하려면 둘 중 하나여야 합니다.
본조사 표본 수를 처음부터 확정해 사전등록하거나, 최대 표본과 중간분석 시점, 중단 규칙까지 미리 정한
순차설계로 사전등록하는 것입니다. 지도교수님과 상의할 사항입니다.
